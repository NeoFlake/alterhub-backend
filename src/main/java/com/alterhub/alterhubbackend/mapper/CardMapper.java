...
public class CardMapper {
    ...
    public CardDTO toDTO(Card card, Integer deckCount) {
        ...
        return CardDTO.builder()
                ...
                .subTypes(card.getSubtypes().stream().map(SubTypeMapper::toDTO).collect(Collectors.toList()))
                .sets(card.getSets().stream().map(SetMapper::toDTO).toList())
    ...
    public Card toEntity(CardDTO cardDTO) {
        ...
        return Card.builder()
                ...
                .sets(cardDTO.getSets().stream().map(SetMapper::toEntity).toList())
